...
#Question 3a
Y_complete_a = Y_complete
marginplot(Y_complete_a, main = "Question 3: complete data")
Y_complete_a$Y2[2*(Y1-1)+Z3<0] = NA
marginplot(Y_complete_a, main = "Question 3a: observed data")
...
Y_completed_b = data.frame(Y1,Y2_3b_sri)
marginplot(Y_completed_b, main = "Question 3b: completed data")


#Question 3c
Y_complete_c = Y_complete
Y_complete_c$Y2[2*(Y2-5)+Z3<0] = NA
marginplot(Y_complete_c, main = "Question 3c: observed data")
...
Y_completed_d = data.frame(Y1,Y2_3d_sri)
marginplot(Y_completed_d, main = "Question 3d: completed data")
